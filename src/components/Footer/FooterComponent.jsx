...
const participants = [
  {
    ...
    imagen: "../src/assets/yesid.jpg",
    descripcion: "Desarrollador Frontend kjasndnvjhdijv ajsnvojasjdvij",
  },
  {
    nombre: "Laura Rosas",
    imagen: "../src/assets/laura.jpg",
    descripcion: "Diseñadora UX/UI",
  },
  {
    nombre: "Gabriel Vera ",
    imagen: "../src/assets/gabriel.jpg",
    descripcion: "Backend Developer",
  },
  {
    nombre: "Alejandro Farelo",
    imagen: "../src/assets/alejandro.jpg",
      ...
      <div className="footer-content">
        ...
        <div className="footer-columns-container">
          ...
          <div className="footer-column social-column">
            <img
              style={{ height: "300px", marginTop: "-65px" }}
              src="../src/assets/logo_ blanco_sin fondo.png"
              alt="logo"
            />

            <h4 style={{ fontWeight: "normal", marginTop: "-50px" }}>
            ...
            <div className="team-members-container">
              {participants.map((participant, index) => (
                <div key={index} className="participant-card">
                  ...
                  <img
                    style={{
                      border: "1px solid rgb(19, 74, 71)",
                      boxShadow: "4px 4px 12px rgba(91, 193, 130, 0.4)",
                    }}
        ...
        {/* Fin de footer-columns-container */}
        {/* Frase final */}
        <div className="footer-bottom-text">2025 Botanic_Panic</div>
      </div>{" "}
      {/* Fin de footer */}
    </footer>
  );
