    ...
    <>
      ...
      <div className="seccion-equipo">
        <h2 style={{ textAlign: "center" }}>
          Quizás todos venimos en diferentes barcos, pero ahora todos estamos en
          el mismo bote. <br />
        ...
        <div className="equipo-grid-centrado">
          {" "}
          {/* Clase para el grid centrado */}
            ...
            <div key={index} className="tarjeta-miembro">
              ...
              <div className="tarjeta-imagen-contenedor">
                <img
                  src={member.img}
                  alt={member.nombre}
                  className="tarjeta-imagen-miembro"
                />
              </div>
              {/* Contenido */}
              <div className="tarjeta-contenido">
                ...
                <div className="tarjeta-redes">
                  <a
                    ...
                    aria-label={`${member.nombre} en Twitter`}
                  >
                    {" "}
                    <FaTwitter />{" "}
                  </a>
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="icono-social"
                    aria-label={`${member.nombre} en LinkedIn`}
                  >
                    {" "}
                    <FaLinkedinIn />{" "}
                  </a>
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="icono-social"
                    aria-label={`${member.nombre} en Github`}
                  >
                    {" "}
                    <FaGithub />{" "}
                  </a>
