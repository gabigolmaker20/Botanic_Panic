          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4 sm:p-12 md:p-20">
            ...
            >
              <button
                ...
                className="absolute top-2 right-2 hover:text-red-600 text-gray-500 hover:text-gray-700 text-2xl transition-colors  rounded-md p-1"
              >
              ...
              <div className="mt-4 flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm text-gray-700">
                    <h6 href={product.href} className="hover:underline">
                      {product.name}
                    </h6>
                  </h3>
