    ...
    const CartIcon = () => <span role="img" aria-label="Carrito">🛒</span>;
    const OrdersIcon = () => <span role="img" aria-label="Pedidos">📦</span>;
    const SettingsIcon = () => <span role="img" aria-label="Configuración">⚙️</span>;
    const CameraIcon = () => <span role="img" aria-label="Cambiar foto">📷</span>;
    const EditIcon = () => <span role="img" aria-label="Editar">✏️</span>; 
    ...
    const defaultCover = 'https://via.placeholder.com/1170x220/E9ECEF/6C757D?text=Cover+Photo';
    const defaultProfile = 'https://via.placeholder.com/150/CCCCCC/808080?text=User';
    ...
    const handleLinkClick = (path) => {
        ...
        console.warn(`UserProfile: onNavigate prop is not defined. Tried to navigate to: ${path}`);
        }
    };
    ...
    const handleChangeProfilePicClick = () => {
        ...
        console.info("UserProfile: onChangeProfilePic prop is not defined. Add functionality if needed.");
    ...
    const handleChangeCoverPicClick = () => {
        ...
        console.info("UserProfile: onChangeCoverPic prop is not defined. Add functionality if needed.");
        }
    };
    ...
    return (
        ...
        <div className="profile-header">
            ...
            <div className="d-flex align-items-md-end align-items-center"> {/* Ajuste para mejor alineación vertical */}
                ...
                {/* Nombre del usuario */}
                <h2 className="user-name h4 mb-1">{userName || 'Nombre de Usuario'}</h2>
                {/* Biografía o estado del usuario (solo si existe) */}
                {userBio && (
                    <p className="user-bio text-muted small mb-0">
                    {userBio}
                    </p>
                )}
                </div>
                ...
                <div className="ms-auto align-self-start pt-md-0 pt-2"> {/* Ajuste de padding top en móvil */}
                <button
        ...
        <div className="quick-links-section card-body border-top">
            ...
            <button
                ...
                aria-label={`Ir a mi carrito, ${itemCount} ${itemCount === 1 ? 'artículo' : 'artículos'}`}
            >
                <CartIcon />
